...
This script is specifying to run an alignment of the paired fastq.gz files for a smaple to a HISAT2 generated index. From here, we can then transform the files to .bam using **SamTools** for reading into **FeaturesCounts**.
