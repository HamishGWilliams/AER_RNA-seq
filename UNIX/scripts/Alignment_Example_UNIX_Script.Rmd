...
There are many different options you can choose from when it comes to FeatureCounts. It's important to carefully read through all of the options to choose from and specifying the ones you need. I'm still not an expert, but I was able to choose a collection of options which were explained from various online resources which can easily be found by searching for featurecounts or subread on search engines. Some of these online resources included:
